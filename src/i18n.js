        ...
        resources: {
            en: {
                translations: {
                    ...
                    'Question.ViewReview':'View my questions reviews`s ',
                    'Survey.ViewReview':'View my survies reviews`s ',
                    'Question.ViewStatus':'View my questions status`s ',
                    'View.Colaborators':'View Colaborators',
                    'Question.Portal':'Question Portal`s',
                    'Survey.Portal':'Survey Portal`s',
                    'Question.Action':'Create new Question',
                    'Survey.Action':'Create new Survey',
                    'Question.Handle':'Handle my questions',
                    'Question.Issues':'Handle issues question`s',
                    'Survey.Handle':'Handle my surveys',
                    'Survey.Collaborators':'Handle collaborators',
                    'Survey.Handle.Issue':'Handle issues survies`s',
                    'Survey.Results':'Handle results of my survies'
                }
            },
            es: {
                translations: {
                        ...
                        'Profile.MyProfile': 'Editar Perfil',
                        'Profile.AcademicProfile': 'Perfil Academico',
                        'Profile.Inbox': 'Bandeja de Entrada',
                        'Profile.AccountSetting': 'Configuracion de cuenta',
                        'Profile.Logout': 'Cerrar Sesion',
                        'Question.ViewReview':'Ver los comentarios realizados a mis preguntas',
                        'Survey.ViewReview':'Ver los comentarios realizados a mis encuestas',
                        'Question.ViewStatus':'Ver el estado de mis preguntas elaboradas',
                        'View.Colaborators':'Ver los colaboradores añadidos a mis encuestas',
                        'Question.Portal':'Portal de Preguntas',
                        'Survey.Portal':'Portal de Encuestas',
                        'Question.Action':'Nueva Pregunta',
                        'Survey.Action':'Nueva Encuesta',
                        'Question.Handle':'Administrar preguntas',
                        'Question.Issues':'Administrar correcciones de preguntas',
                        'Survey.Handle':'Administrar encuestas',
                        'Survey.Collaborators':'Colaboradores de encuestas',
                        'Survey.Handle.Issue':'Manejar correcciones de encuestas',
                        'Survey.Results':'Manejar resultados de mis encuestas'
                }
            }
        },
        fallbackLng: "en",
